...
const YesIntentHandler = {
    ...
    let intent='entro yesIntent'
      ...
      let resPost= await logic.postLogs(sessionAttributes['access_token'], intent,logic.convertDateForDatabase(moment().tz( "Europe/Rome")))
        ...
        console.log('all ' + sessionAttributes['all_therapies'])
       console.log('all reminders pre ' + JSON.stringify(await reminderApiClient.getReminders() ))
       ...
       console.log('rem id to update ' + JSON.stringify(reminder_idToUpdate))
   ...
   sessionAttributes['reminders'] = reminders_ids_leftA;
    ...
    console.log('all reminders post ' + JSON.stringify(await reminderApiClient.getReminders() ))
    ...
    console.log('rem post ' + JSON.stringify(reminder_idToUpdate))
